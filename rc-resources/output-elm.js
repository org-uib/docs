...
var $author$project$Main$dataUrl = 'data/bergen_internal_research.json';
var $author$project$Main$Basic = {$: 'Basic'};
var $author$project$Main$InProgress = {$: 'InProgress'};
var $author$project$Main$KMD_Art = {$: 'KMD_Art'};
var $author$project$Main$KMD_Design = {$: 'KMD_Design'};
var $author$project$Main$KMD_Grieg = {$: 'KMD_Grieg'};
var $author$project$Main$KMD_PhD = {$: 'KMD_PhD'};
...
var $author$project$Main$Research = F9(
	function (id, title, keywords, created, author, researchType, issueId, publicationStatus, publication) {
		return {author: author, created: created, id: id, issueId: issueId, keywords: keywords, publication: publication, publicationStatus: publicationStatus, researchType: researchType, title: title};
	});
...
var $author$project$Main$isKMD_Art = function (research) {
	return A2($elm$core$List$member, 'KMD_Art', research.keywords);
};
var $author$project$Main$isKMD_Design = function (research) {
	return A2($elm$core$List$member, 'KMD_Design', research.keywords);
};
var $author$project$Main$isKMD_Grieg = function (research) {
	return A2($elm$core$List$member, 'KMD_Grieg', research.keywords);
};
var $author$project$Main$isKMD_PhD = function (research) {
	return A2($elm$core$List$member, 'KMD_PhD', research.keywords);
};
...
var $author$project$Main$entry = function () {
	...
	var researchType = function (research) {
		return _Utils_update(
			research,
			{
				researchType: $author$project$Main$isKMD_Grieg(research) ? $author$project$Main$KMD_Grieg : ($author$project$Main$isKMD_Design(research) ? $author$project$Main$KMD_Design : ($author$project$Main$isKMD_Art(research) ? $author$project$Main$KMD_Art : ($author$project$Main$isKMD_PhD(research) ? $author$project$Main$KMD_PhD : $author$project$Main$Basic)))
			});
	};
		...
		switch (msg.$) {
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{includeInternalResearch: includeInternal}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$ToggleInternalPublicationFilter = function (a) {
	return {$: 'ToggleInternalPublicationFilter', a: a};
};
...
var $author$project$Main$statusToString = function (status) {
	switch (status.$) {
		...
		case 'LocalPublication':
			return 'KMD portal members only!';
		default:
			return '...';
	}
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(research.title)
							]))
					])),
				A2(
				$elm$html$Html$p,
...
var $author$project$Main$viewResearch = function (model) {
	...
	var publicInternalSwitch = function () {
		var helperWarning = model.includeInternalResearch ? ' (these are accessible to staff and students only)' : '';
		return A2(
			$elm$html$Html$label,
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									$rundis$elm_bootstrap$Bootstrap$Form$Checkbox$checked(model.includeInternalResearch)
								]),
	...
	var filteredOnStatus = model.includeInternalResearch ? filtered : A2(
		$elm$core$List$filter,
		function (research) {
			var _v1 = research.publicationStatus;
			if (_v1.$ === 'LocalPublication') {
				return model.includeInternalResearch;
			} else {
				return true;
			}
		},
						...
						[
							...
							_List_fromArray(
								[
									...
									_Utils_eq(
										current,
										$author$project$Main$Only($author$project$Main$KMD_Grieg)),
									_List_fromArray(
										[
											$rundis$elm_bootstrap$Bootstrap$Button$light,
											$rundis$elm_bootstrap$Bootstrap$Button$onClick(
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Grieg Academy')
										])),
									A3(
									$rundis$elm_bootstrap$Bootstrap$ButtonGroup$radioButton,
									_Utils_eq(
										current,
										$author$project$Main$Only($author$project$Main$KMD_Design)),
									_List_fromArray(
										[
											$rundis$elm_bootstrap$Bootstrap$Button$light,
											$rundis$elm_bootstrap$Bootstrap$Button$onClick(
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Design department')
										])),
									A3(
									$rundis$elm_bootstrap$Bootstrap$ButtonGroup$radioButton,
									_Utils_eq(
										current,
										$author$project$Main$Only($author$project$Main$KMD_Art)),
									_List_fromArray(
										[
											$rundis$elm_bootstrap$Bootstrap$Button$light,
											$rundis$elm_bootstrap$Bootstrap$Button$onClick(
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Fine Art')
										])),
									A3(
									$rundis$elm_bootstrap$Bootstrap$ButtonGroup$radioButton,
									_Utils_eq(
										current,
										$author$project$Main$Only($author$project$Main$KMD_PhD)),
									_List_fromArray(
										[
											$rundis$elm_bootstrap$Bootstrap$Button$light,
											$rundis$elm_bootstrap$Bootstrap$Button$onClick(
	...
	var content = function () {
		...
		if (_v0.$ === 'TableView') {
			return A2(
				$elm$html$Html$div,
				_List_Nil,
				A4($author$project$Main$viewResearchList, model.tableState, model.titleQuery, model.query, filteredOnStatus));
		} else {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('University of Bergen - KMD')
							])),
						A2(
						$elm$html$Html$a,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('https://www.researchcatalogue.net/view/1310123/1435694')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Back to Research Portal')
							]))
					])),
				filterSwitch,
